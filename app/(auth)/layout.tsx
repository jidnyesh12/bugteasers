      ...
      <div className="hidden lg:flex lg:w-[46%] bg-[var(--accent-primary)] flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-12">
          ...
          >
            ...
            >
              <path
                d="M260 42L262 48L268 48L263 52L265 58L260 54L255 58L257 52L252 48L258 48Z"
                fill="white"
                fillOpacity="0.3"
              />
            </g>
            <g
              className="animate-wiggle animate-delay-300"
              style={{ transformOrigin: "50px 240px" }}
            >
              <path
                d="M50 234L51.5 238L56 238L52.5 241L53.5 245L50 242.5L46.5 245L47.5 241L44 238L48.5 238Z"
                fill="white"
                fillOpacity="0.25"
              />
            </g>
