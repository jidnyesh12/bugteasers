...
export default function AssignmentsPage() {
  ...
  const formatDeadline = (deadline: string, closedAt?: string | null) => {
    ...
    const isClosed =
      Number.isFinite(closedTimestamp) && closedTimestamp <= nowTime;
  ...
  return (
    <div className="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <Button
          onClick={() => router.push("/dashboard/instructor/assignments/new")}
        >
          <svg
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-xs text-[var(--text-muted)]">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>
                          {assignment.classroom_count || 0} classroom
                          {(assignment.classroom_count || 0) !== 1 ? "s" : ""}
                        </span>
                      </div>
                      <span>•</span>
                      <div className="flex items-center gap-1.5">
