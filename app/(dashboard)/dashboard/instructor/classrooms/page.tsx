...
export default function ClassroomsPage() {
  ...
  const { data: classrooms = [], isFetching: loading } = useQuery<Classroom[]>({
  ...
  const { mutateAsync: createClassroomAsync, isPending: creating } =
    useMutation({
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      queryClient.setQueryData<Classroom[]>(
        queryKeys.classrooms.instructorMine,
    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[var(--text-secondary)] mt-1">
            Create and manage your class batches. Share join codes with
            students.
          </p>
        </div>
        ...
        <div className="flat-card flex flex-col items-center justify-center py-20 text-center">
          ...
          >
            ...
            <g transform="translate(22, 25)">
              <path
                d="M2 4C2 4 10 0 23 0C36 0 44 4 44 4V36C44 36 36 32 23 32C10 32 2 36 2 36V4Z"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {classrooms.map((c) => (
            <div
              key={c.id}
              onClick={() =>
                router.push(`/dashboard/instructor/classrooms/${c.id}`)
              }
            ...
            >
                ...
                <div className="flex items-center gap-4 text-sm text-[var(--text-secondary)]">
                  ...
                  >
                    ...
                    <span className="font-semibold">
                      {c.classroom_students?.[0]?.count || 0}
                    </span>
                  </div>
                  <div
                    className="flex items-center gap-1.5"
                  ...
                  >
                    ...
                    <span className="font-semibold">
                      {c.classroom_assignments?.[0]?.count || 0}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="px-5 py-3 bg-[var(--bg-tertiary)]/50 border-t border-[var(--border-primary)] flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-mono font-bold text-[var(--text-primary)] tracking-widest">
                    {c.join_code}
                  </span>
                </div>
                <button
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div
            className="relative w-full max-w-lg mx-4 bg-white rounded-2xl border-2 border-[var(--border-primary)] animate-slide-up"
