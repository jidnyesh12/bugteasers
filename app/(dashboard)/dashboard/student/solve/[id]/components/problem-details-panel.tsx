            ...
            {problem.examples && problem.examples.length > 0 && (
              <div className="mt-8 space-y-6">
                {problem.examples.map((example, index) => (
                  <div key={index} className="rounded-md border border-[var(--border-primary)] overflow-hidden text-sm">
            ...
            {(!problem.hints || problem.hints.length === 0) ? (
              ...
              <div className="space-y-3">
                {problem.hints.map((hint, index) => (
                  <div key={index} className="rounded-xl border border-[var(--border-primary)] overflow-hidden">
                    {revealedHints.includes(index) ? (
                      <div className="p-4 bg-amber-50/50">
                        <p className="text-xs font-bold text-amber-700 mb-1">Hint {index + 1}</p>
                      ...
                      >
                        <span className="text-sm font-semibold text-[var(--text-primary)]">Hint {index + 1}</span>
