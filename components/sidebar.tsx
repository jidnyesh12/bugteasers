...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 sticky top-16 self-start h-[calc(100vh-4rem)] border-r-2 border-[var(--border-primary)] bg-white p-4 gap-1 overflow-y-auto">
      {links.map((link) => {
