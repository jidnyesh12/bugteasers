...
describe('buildRetryContextSection', () => {
  ...
  it('includes all previous errors in output', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'ai_generating', error: 'JSON parse error', timestamp: '2026-01-01T00:00:01.000Z' },
      { attempt: 2, stage: 'validating', error: 'Compile error in C++', timestamp: '2026-01-01T00:00:05.000Z' },
    ];
  ...
  it('adds JSON fix instructions when errors contain "json" or "parse"', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'ai_generating', error: 'Invalid JSON format', timestamp: '2026-01-01T00:00:01.000Z' },
    ];
  ...
  it('adds code fix instructions when errors contain "compile" or "syntax"', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'validating', error: 'Compile error in solution', timestamp: '2026-01-01T00:00:01.000Z' },
    ];
  ...
  it('adds template fix instructions when errors contain "template"', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'ai_generating', error: 'Test case has invalid input_template', timestamp: '2026-01-01T00:00:01.000Z' },
    ];
  ...
  it('adds output mismatch instructions when errors contain "mismatch"', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'validating', error: 'model solution output mismatch', timestamp: '2026-01-01T00:00:01.000Z' },
    ];
  ...
  it('adds multiple fix sections when multiple error types exist', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'ai_generating', error: 'Invalid JSON parse error', timestamp: '2026-01-01T00:00:01.000Z' },
      { attempt: 2, stage: 'validating', error: 'Compile syntax error', timestamp: '2026-01-01T00:00:05.000Z' },
    ];
  ...
  it('labels stage correctly for ai_generating', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'ai_generating', error: 'Some error', timestamp: '2026-01-01T00:00:01.000Z' },
    ];
  ...
  it('labels stage correctly for validating', () => {
    const history: RetryHistoryEntry[] = [
      { attempt: 1, stage: 'validating', error: 'Some error', timestamp: '2026-01-01T00:00:01.000Z' },
    ];
