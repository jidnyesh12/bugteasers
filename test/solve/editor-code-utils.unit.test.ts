...
describe('solve editor code utils', () => {
  ...
  it('places starter comment at the student coding position', () => {
    ...
    expect(javaStarter).toContain('public static void main(String[] args) throws Exception {\n        // Write your solution here');
    expect(cppStarter.indexOf('cin.tie(nullptr);')).toBeLessThan(cppStarter.indexOf('// Write your solution here'));
    expect(cStarter).toContain('int main(void) {\n    // Write your solution here');
