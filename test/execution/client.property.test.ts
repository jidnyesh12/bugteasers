    ...
    fc.assert(
      fc.property(
        ...
        (language) => {
          ...
          const validPistonLanguages: PistonLanguage[] = ['python', 'java', 'c++', 'c'];
...
describe('Piston API Requests Are Well-Formed', () => {
  ...
  const executionRequestArbitrary = fc.record({
    ...
    compile_timeout: fc.option(fc.integer({ min: 1000, max: 30000 }), { nil: undefined }),
    run_timeout: fc.option(fc.integer({ min: 1000, max: 30000 }), { nil: undefined }),
    compile_memory_limit: fc.option(fc.integer({ min: 1000000, max: 100000000 }), { nil: undefined }),
    run_memory_limit: fc.option(fc.integer({ min: 1000000, max: 100000000 }), { nil: undefined }),
  });
