...
const stats: Array<{
...
}> = [
  {
    ...
    sub: (value) =>
      value === 0 ? "Create your first" : `${value} in your bank`,
    color: "#2B3F7E",
    icon: (
      <svg
  ...
  },
  {
    ...
    sub: (value) =>
      value === 0 ? "All caught up" : `${value} awaiting review`,
    color: "#F39C12",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    sub: (value) =>
      value === 0 ? "Invite students" : `${value} currently active`,
    color: "#1DB97A",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    sub: (value) =>
      value === 0
        ? "Create classroom"
        : `${value} classroom${value === 1 ? "" : "s"} live`,
    color: "#7C9CC4",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export default function InstructorDashboard() {
  ...
  const { data: dashboardData, isFetching: isStatsLoading } = useQuery({
          ...
          {isStatsLoading && !dashboardData ? (
            ...
            <div className="flex flex-col items-center justify-center py-14 text-center">
              ...
              <p className="text-xs text-[var(--text-muted)] mt-1 max-w-xs">
                Student submissions will appear here once they start solving
                problems
              </p>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <span
                        className={`flat-badge ${recentSubmissionBadgeStyles[submission.status]}`}
                      >
