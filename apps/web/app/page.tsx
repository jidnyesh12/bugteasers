            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-3">
                {user ? (
                  <Link
                    href={dashboardHref}
                    className="px-5 py-2 text-sm font-semibold bg-[var(--accent-primary)] text-white rounded-lg hover:bg-[var(--accent-primary-hover)] transition-colors"
                  >
                    Go to Dashboard
                  </Link>
                ) : (
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="animate-slide-up">
                ...
                <p className="text-lg text-white/80 leading-relaxed mb-8 max-w-lg">
                  CodeGuru AI gives you Socratic hints that make you think, not
                  answers that do the work for you. Master programming through
                ...
                <div className="relative">
                  ...
                  <div className="bg-white rounded-2xl border border-[var(--border-primary)] shadow-xl p-6 w-[380px]">
                    ...
                    <div className="bg-[#1e1e2e] rounded-xl p-4 font-mono text-sm space-y-1.5">
                      ...
                      <p className="text-green-400 pl-12">
                        return [seen[diff], i]
                      </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="mb-14">
              ...
              <p className="text-[var(--text-secondary)] mt-4 text-base max-w-lg leading-relaxed">
                Most tools give you answers. We give you the question that leads
                to the answer — because that&apos;s what actually builds skill.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2 bg-[var(--accent-primary)] rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/65 text-sm leading-relaxed max-w-md">
                    Stuck on a problem? Get a hint that asks you the right
                    question — not one that hands you the solution. You build
              ...
              <div className="flex flex-col gap-4">
                <div className="flex-1 bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-2xl p-6">
                  ...
                  <h3 className="text-sm font-black text-[var(--text-primary)] mb-2 tracking-tight">
                    Live Code Execution
                  </h3>
                  <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                    Write and run your solution right in the browser. Instant
                    test case feedback, no setup needed.
                  </p>
                </div>
                <div className="flex-1 bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-2xl p-6">
                  ...
                  <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                    See where you improve and where you struggle. Instructors
                    track your classroom in real time.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[var(--accent-primary)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <p className="text-[var(--accent-tertiary)] text-xs font-black uppercase tracking-widest mb-5">
                  The Philosophy
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="text-[var(--text-secondary)] mb-10 text-base leading-relaxed">
                Join CodeGuru AI and learn to solve problems — not just copy
                solutions.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link
                  href="/login"
                  className="inline-flex items-center justify-center px-8 py-3.5 text-[var(--text-secondary)] font-semibold rounded-xl hover:bg-[var(--bg-secondary)] transition-colors text-base border border-[var(--border-primary)]"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 pb-10 border-b border-white/10">
              ...
              <div className="max-w-xs">
                ...
                <p className="text-sm text-white/50 leading-relaxed">
                  AI-powered coding education that builds real skills through
                  guided problem-solving.
                </p>
              </div>
            ...
            <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
              <p className="text-xs text-white/30">
                &copy; 2026 CodeGuruAI. All rights reserved.
              </p>
              <p className="text-xs text-white/25">
                Built for learners who want to actually understand code.
              </p>
            </div>
          </div>
        </footer>
