...
export function Sidebar({ isOpen = true, onToggleSidebar }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`mt-auto pb-5 pt-4 border-t border-[var(--border-primary)] ${isOpen ? "px-4" : "px-2"}`}
      >
        <div
          className={`flex items-center ${isOpen ? "gap-2.5" : "justify-center"}`}
        >
